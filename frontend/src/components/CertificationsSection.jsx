  ...
  const certifications = [
    {
      ...
      date: '2023',
      description: 'Comprehensive certification covering JavaScript fundamentals, ES6+ features, and modern web development practices',
      verified: true
    },
    {
      icon: Shield,
      ...
      issuer: 'Cisco Networking Academy',
      date: '2022',
      description: 'Foundation in programming logic, data structures, and object-oriented programming principles',
      verified: true
    },
    {
      icon: Award,
      ...
      date: '2023 - Present',
      description: 'Built portfolio of production-ready applications including game development, image editing tools, and interactive web apps',
      verified: true
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Certifications & <span className="text-[#0ea5e9]">Achievements</span>
          </h2>
          <div className="w-20 h-1 bg-gradient-to-r from-[#0ea5e9] to-[#06b6d4] mx-auto mb-6"></div>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Validated skills and recognized accomplishments in frontend development
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {certifications.map((cert, index) => {
            ...
            return (
              <Card 
                key={index}
                className="bg-gradient-to-br from-[#1a1a1b] to-[#0a0a0b] border-white/10 p-6 hover:border-[#0ea5e9]/30 transition-all duration-300 group hover:shadow-xl hover:shadow-[#0ea5e9]/10"
              >
